...
import time
#import /home/pi/bitcoin/bitcoin

import requests
import json
response_API = requests.get('https://newsapi.org/v2/everything?q=ethereum&apiKey=7ea059517aa64297ab570757422879d5')
data = response_API.text
parse_json = json.loads(data)
sf=""
for i in range(4):
    sf= sf + parse_json['articles'][i]['title']+"   "
st=sf.lower()
st=st.replace(" ' "," ")
st=st.replace("$"," usd ")
print(st)
...
if __name__ == '__main__':
    ...
    P.add_option('--message', action='store_true',
                 default=st, help='Send a message.')
